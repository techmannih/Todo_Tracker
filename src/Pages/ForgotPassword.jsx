...
const ForgotPassword = () => {
  ...
  return (
    <div className="container bg-black flex  p-8 m-8 text-white border-white border-2  rounded-xl">
      <div className="">
        ...
        <div className="text-center py-3 m-5 hover:bg-white hover:text-black  border-white border-2 rounded-2 rounded-xl">
          <input className='cursor-pointer font-bold ' type="button" value={"Back to Login"} onClick={()=> navigate('/')}/>
        </div>
      </div>+
    </div>
  )
